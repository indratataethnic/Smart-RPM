...
import { Sparkles, Loader2, ArrowRight, RotateCcw, AlertCircle } from 'lucide-react';
...
const INITIAL_FORM_DATA: LessonFormData = {
  ...
  semesterTahun: 'Semester 1 / TA 2025/2026',
            ...
            <div className="bg-gradient-to-r from-slate-900 via-teal-950 to-slate-900 text-white p-6 sm:p-8 rounded-3xl shadow-xl border border-slate-800 flex flex-col md:flex-row items-center justify-between gap-6">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-2 w-full md:w-auto shrink-0">
                <button
                  ...
                  className="w-full sm:w-auto px-4 py-2.5 rounded-xl text-xs font-bold bg-slate-800 hover:bg-slate-700 text-teal-300 border border-teal-500/40 transition-all cursor-pointer flex items-center justify-center gap-1.5"
                >
                  <RotateCcw className="w-3.5 h-3.5" />
                  <span>Isi Contoh Matematika SMP</span>
                </button>
              </div>
            </div>
